...
contract LootVirtualLand is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        parts[0] = '<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 360 360"><style>.base { fill: white; font-family: serif; font-size: 14px; }</style><rect width="100%" height="100%" fill="goldenrod" /><text x="93" y="30" class="base">~ LAND TITLE ~</text><text x="20" y="50" class="base">';
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "Lot #', StrUtil.toString(tokenId), '", "description": "Loot Virutal Land is a collection of 10,000 NFTs", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '"}'))));
    ...
    constructor() ERC721("LootVirtualLand", "LOOTLAND") Ownable() {}
}
